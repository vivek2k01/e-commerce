...
const Adminagarbatti = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `Agarbatti/${formData.id}`), formData)
      .then(() => {
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Agarbatti</h1>
      </Typography>
