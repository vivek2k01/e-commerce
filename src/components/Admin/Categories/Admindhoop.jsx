...
const Admindhoop = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `Dhoop/${formData.id}`), formData)
      .then(() => {
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Dhoop Batti</h1>
      </Typography>
