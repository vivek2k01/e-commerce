...
const Adminpoojathali = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `Jewelry/${formData.id}`), formData)
      .then(() => {
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Jewelry</h1>
      </Typography>
...
export default Adminpoojathali;
