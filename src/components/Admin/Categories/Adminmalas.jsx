...
const Adminmalas = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `Malas/${formData.id}`), formData)
      .then(() => {
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Malas</h1>
      </Typography>
