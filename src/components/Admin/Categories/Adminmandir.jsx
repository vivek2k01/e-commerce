...
const Adminmandir = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `Mandir/${formData.id}`), formData)
      .then(() => {
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Mandir</h1>
      </Typography>
