...
const Adminmurti = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `murti/${formData.id}`), formData)
      .then(() => {
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Murti & Idols</h1>
      </Typography>
