...
const Adminpoojaessentials = () => {
  ...
  useEffect(() => {
    const itemsRef = ref(db, "Poojaessentials");
  ...
  const handleImageChange = async (e) => {
    ...
    data.append("upload_preset", "e-commerce"); // 🔑 unsigned preset name
  ...
  const handleSave = () => {
    ...
    set(ref(db, `Poojaessentials/${formData.id}`), formData)
      .then(() => {
  ...
  const handleDelete = (id) => {
    remove(ref(db, `Poojaessentials/${id}`))
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Puja Essentials</h1>
      </Typography>
...
export default Adminpoojaessentials;
