...
const Admintechpro = () => {
  ...
  useEffect(() => {
    const itemsRef = ref(db, "Tech Products");
  ...
  const handleSave = () => {
    ...
    set(ref(db, `Tech Products/${formData.id}`), formData)
      .then(() => {
  ...
  const handleDelete = (id) => {
    remove(ref(db, `Tech Products/${id}`))
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Tech Products</h1>
      </Typography>
