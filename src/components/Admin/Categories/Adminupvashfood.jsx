...
const Adminupvashfood = () => {
  ...
  useEffect(() => {
    const itemsRef = ref(db, "Upvash food");
  ...
  const handleSave = () => {
    ...
    set(ref(db, `Upvash food/${formData.id}`), formData)
      .then(() => {
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Upvash Food</h1>
      </Typography>
...
export default Adminupvashfood;
