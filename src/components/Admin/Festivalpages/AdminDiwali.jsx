...
const AdminDiwali = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `diwali/${formData.id}`), formData)
      .then(() => {
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Diwali</h1>
      </Typography>
