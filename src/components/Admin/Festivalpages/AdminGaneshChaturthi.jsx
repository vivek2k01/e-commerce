...
const AdminGaneshChaturthi = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `ganeshchaturthi/${formData.id}`), formData)
      .then(() => {
  ...
  const handleDelete = (id) => {
    remove(ref(db, `ganeshchaturthi/${id}`))
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Ganesh Chaturthi</h1>
      </Typography>
...
export default AdminGaneshChaturthi;
