...
const AdminNavDurgaPuja = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `navdurgapuja/${formData.id}`), formData)
      .then(() => {
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Nav Durga Puja</h1>
      </Typography>
...
export default AdminNavDurgaPuja;
