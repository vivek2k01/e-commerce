...
const AdminRamnavami = () => {
  ...
  useEffect(() => {
    const itemsRef = ref(db, "ramnavami");
  ...
  const handleSave = () => {
    ...
    set(ref(db, `ramnavami/${formData.id}`), formData)
      .then(() => {
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Ram Navami</h1>
      </Typography>
