...
const Adminchhathpuja = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `chhathpuja/${formData.id}`), formData)
      .then(() => {
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Chhath Puja</h1>
      </Typography>
...
export default Adminchhathpuja;
