...
const Adminhomedecore = () => {
  ...
  useEffect(() => {
    const itemsRef = ref(db, "Homedecore");
  ...
  const handleSave = () => {
    ...
    set(ref(db, `Homedecore/${formData.id}`), formData)
      .then(() => {
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Home Decore</h1>
      </Typography>
...
export default Adminhomedecore;
