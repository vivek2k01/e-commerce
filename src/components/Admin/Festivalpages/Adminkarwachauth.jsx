...
const Adminkarwachauth = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `Karwachauth/${formData.id}`), formData)
      .then(() => {
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Karwachauth</h1>
      </Typography>
...
export default Adminkarwachauth;
