...
const Adminkrishnajanmastami = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `krishnajanmashtami/${formData.id}`), formData)
      .then(() => {
  ...
  const handleDelete = (id) => {
    remove(ref(db, `krishnajanmashtami/${id}`))
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>krishna Janmashtami</h1>
      </Typography>
...
export default Adminkrishnajanmastami;
