...
const AdminmahaShivratri = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `mahashivratri/${formData.id}`), formData)
      .then(() => {
  ...
  const handleDelete = (id) => {
    remove(ref(db, `mahashivratri/${id}`))
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Maha Shivratri</h1>
      </Typography>
...
export default AdminmahaShivratri;
