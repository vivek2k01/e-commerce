...
const Adminmakarshakranti = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `makarshakranti/${formData.id}`), formData)
      .then(() => {
  ...
  const handleDelete = (id) => {
    remove(ref(db, `makarshakranti/${id}`))
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Makarshakranti</h1>
      </Typography>
...
export default Adminmakarshakranti;
