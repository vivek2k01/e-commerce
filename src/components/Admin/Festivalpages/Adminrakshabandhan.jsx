...
const Adminrakshabandhan = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `rakshabandhan/${formData.id}`), formData)
      .then(() => {
  ...
  const handleDelete = (id) => {
    remove(ref(db, `rakshabandhan/${id}`))
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Rakshabandhan</h1>
      </Typography>
...
export default Adminrakshabandhan;
