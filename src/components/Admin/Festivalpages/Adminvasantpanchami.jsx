...
const Adminvasantpanchami = () => {
  ...
  const handleSave = () => {
    ...
    set(ref(db, `vasantpanchami/${formData.id}`), formData)
      .then(() => {
  ...
  const handleDelete = (id) => {
    remove(ref(db, `vasantpanchami/${id}`))
  ...
  return (
    ...
    >
      <Typography>
        <h1 style={{ fontFamily: "Georgia, serif" }}>Vasantpanchami</h1>
      </Typography>
...
export default Adminvasantpanchami;
